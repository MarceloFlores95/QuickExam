...
question_open_parser.add_argument('variables', type=list, location='json')
...
question_tf_parser.add_argument('variables', type=list, location='json')
...
question_multi_parser.add_argument('variables', type=list, location='json')
...
test_parser.add_argument('encabezado', type=str)
